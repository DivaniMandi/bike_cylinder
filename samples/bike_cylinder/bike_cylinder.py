...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("bike_cylinder", 1, "bike_cylinder")
        ...
        for a in annotations:
            ...
            self.add_image(
                "bike_cylinder",  ## for a single class just add the name here
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "bike_cylinder":
